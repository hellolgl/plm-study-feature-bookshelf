...
export default class HelpModal extends Component {
    ...
    renderchild = () => {
        ...
        return (
            ...
            >
                <View
                    style={[{ position: "absolute", top: pxToDp(80), left: pxToDp(240) }]}
                >
                ...
                <Text
                    style={[
                        appFont.fontFamily_jcyt_700,
                        {
                            ...
                            lineHeight: pxToDp(Platform.OS === "ios" ? 120 : 110),
                        },
                    ]}
                >
                    {info.word}
    ...
    renderItem = (info, imageStyle, titleStyle, txtStyle, wrapStyle) => {
        return (
            <View style={[appStyle.flexCenter, borderRadius_tool(30), wrapStyle]}>
                <Text
                    style={[
                        appFont.fontFamily_jcyt_700,
                        {
                            ...
                            lineHeight: pxToDp(Platform.OS === "ios" ? 80 : 70),
                        },
                        titleStyle,
                    ]}
                >
                ...
                <Text
                    style={[
                        appFont.fontFamily_jcyt_500,
                        {
                            fontSize: pxToDp(46),
                            color: "#fff",
                            lineHeight: pxToDp(Platform.OS === "ios" ? 60 : 50),
                            marginBottom: pxToDp(20),
                        },
                        txtStyle,
                    ]}
        ...
        return (
            <View style={[styles.wordWrap, appStyle.flexJusBetween]}>
                {this.renderItem(
                    ...
                    {
                        fontSize: pxToDp(75),
                        lineHeight: pxToDp(Platform.OS === "ios" ? 90 : 80),
                    },
                    {
                        fontSize: pxToDp(54),
                        lineHeight: pxToDp(Platform.OS === "ios" ? 70 : 60),
                ...
                >
                    ...
                    <View
                        style={[
                            { flex: 1, backgroundColor: "#313131", height: "100%" },
                            appStyle.flexCenter,
                            borderRadius_tool(60),
                            appStyle.flexTopLine,
                            appStyle.flexJusCenter,
                            padding_tool(0, 50, 0, 50),
                        ]}
                    >
                        {list[1]
                            ? this.renderItem(
                                ...
                                {},
                                {},
                                { backgroundColor: "#444", ...size_tool(540, 720) }
                            )
                            : null}
                        {list[2]
                            ? this.renderItem(
    ...
    renderSentence = () => {
        ...
        return (
            <View style={[{ flex: 1, width: "100%" }, padding_tool(10, 70, 70, 90)]}>
                <Text
                    style={[
                        appFont.fontFamily_jcyt_700,
                        { fontSize: pxToDp(66), color: "#fff" },
                    ]}
                >
                    解析:
                </Text>
        ...
        return (
            <View>
                ...
                >
                    ...
                    >
                        <View style={[styles.modalHeader, appStyle.flexJusCenter]}></View>
                        <View style={[{ flex: 1 }, appStyle.flexCenter]}>
                            ...
                            >
                                <View style={[styles.wordmainInBg]}>
                                    {!isSen ? this.renderCard() : this.renderSentence()}
                                </View>
                            </ImageBackground>
                        </View>
                    </ImageBackground>
