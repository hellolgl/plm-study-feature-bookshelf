        ...
        const fetchData = async () => {
            if (!messages.length) {
                ...
                if (chatLoading === false) {
                    const history_res = await axios.post(api.getGrammarAIBotHistory, data);
                    ...
                    try {
                        const res = await axios.post(api.getGrammarAIHelp, data)
