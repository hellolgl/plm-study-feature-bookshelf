                        ...
                        (fill) => (
                            this.props.type === 'percent'?
                                ...
                                : <View style={[{ backgroundColor: '#FFFFFFFF', width: '100%', height: '100%', alignItems: 'center', justifyContent: 'center' }]}>
                                    {this.props.total?<Text style={[{ color:'#77D102', fontSize: pxToDp(48)},this.props.percentTxtStyle?this.props.percentTxtStyle:null]}>
                                        {this.props.total}
                                    </Text>:null}
                                    {this.props.totalText?<Text style={{ fontSize: pxToDp(20), color: '#AAAAAA',fontWeight:'bold' }}>{this.props.totalText}</Text>:null}
                                </View>
                        )
                    }
                </AnimatedCircularProgress>
