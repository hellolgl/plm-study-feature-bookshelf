...
class DoWrongExercise extends PureComponent {
    ...
    renderWriteTopaic = () => {
        ...
        let public_stem = data?.public_exercise_stem
        console.log('data?.public_exercise_stem======', data?.public_exercise_stem)
        return (
            // 不同题型组装题目
            <View>
                <View
                    ...
                    <View style={[{ flex: 1, paddingRight: pxToDp(30) }, appStyle.flexJusBetween, appStyle.flexTopLine]}>
                        <View style={[appStyle.flexTopLine, {
                            ...
                            <View style={[{ position: 'relative', flex: 1 }]}>
                                ...
                                {public_stem ? <RichShowView value={public_stem ?
                                    `<div >${public_stem}</div>` : ""}
    ...
    componentDidUpdate(prevProps, prevState,) {
        console.log('exercise=======', prevState.exerciseInfo)
    ...
    render() {
        ...
        console.log('topaicNum', knowledgeBody)
