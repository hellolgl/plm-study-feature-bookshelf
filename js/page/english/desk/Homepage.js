...
class YuwenHomePage extends PureComponent {
    ...
    getHomeWork = () => {
        ...
        const userInfoJs = userInfo.toJS();
        axios
            .get(api.getEnglishMyDescHistory, {
                params: {
    ...
    getHomeWorkWrong = (type, page) => {
        ...
        axios
            .get(api.getEnglishMyDescHistoryWrong, {
                params: {
                    grade_code: userInfoJs.checkGrade,
                    term_code: userInfoJs.checkTeam,
            ...
            .then((res) => {
                // operate_time
                // console.log("返回来", res.data.data.data);
                this.setState(() => ({
                    checkIndex: 2,
                    page,
    ...
    lookAllHistory = (item) => {
        NavigationUtil.toEnglishDescRecord({
            ...this.props,
            data: {
                ...item,
                type: "desc",
    ...
    lookExercise = (item) => {
        NavigationUtil.toEnglishDescDoWrong({
            ...this.props,
            data: { ...item },
        });
    };
    renderWrong = () => {
        ...
        console.log("checkWrongType", checkWrongType);
        return (
            <View
                style={[
                    { flex: 1, height: "100%" },
                ...
                {wrongExerciseList && wrongExerciseList.length > 0 ? (
                    <View style={[{ flex: 1 }, padding_tool(0, 45, 0, 45)]}>
                      ...
                      value={item.private_exercise_stem} width={pxToDp(1100)}></RichShowView> */}
                        ...
                        >
                            <Image
                                source={require("../../../images/english/homework/left.png")}
                        ...
                        >
                            <Image
                                source={require("../../../images/english/homework/right.png")}
                                style={[Platform.OS === "ios" ? size_tool(120) : size_tool(90)]}
                                resizeMode="contain"
                            />
                        </TouchableOpacity>
    ...
    render() {
        const { checkIndex, leftNavList, titleList, show } = this.state;
        return (
            <ImageBackground
            ...
            >
                <View style={[styles.header]}>
                    <View style={[styles.inner]}>
                                    ...
                                    >
                                        ...
                                        >
                                            <Text
                                                style={[
                                                    styles.txt_1,
                                                    { color: checkIndex === x ? "#8843B8" : "#475266" },
                                                ]}
                                            >
                                                {i.text}
                                            </Text>
                        ...
                        >
                            <Text style={[styles.changeBtnTxt]}>英语作业</Text>
                            <Image
