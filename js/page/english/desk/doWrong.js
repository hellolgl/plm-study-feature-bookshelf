...
class LookAllExerciseHome extends PureComponent {
    ...
    saveExercise = async (value) => {
        console.log('value====', value.correct)
    ...
    render() {
        ...
        return (
            <ImageBackground
                ...
                <View style={[{ height: pxToDp(140), width: pxToDp(1700), marginBottom: pxToDp(20) }, borderRadius_tool(0, 0, 30, 30), appStyle.flexCenter, padding_tool(0, 40, 0, 80)]}>
                    ...
                    >
                        {
                            list.length > 0 ?
                                <View style={[{
                                    ...
                                    {/* {list.length > 0 && list[listindex]?.exercise_type_private === '3' ?
                                        <MixExercise exercise={{
                                            ...list[listindex],
                                            stem: show_translate ? list[listindex].stem + list[listindex].translate_stem.en : list[listindex].stem,
                                            knowledgepoint_explanation: show_translate ? list[listindex].knowledgepoint_explanation + list[listindex]?.translate_explanation?.en : list[listindex].knowledgepoint_explanation
                                        }} saveExercise={this.saveExercise} /> :
                                        null}
