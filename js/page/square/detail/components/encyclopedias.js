...
function Encyclopedias({ next, seeKnowledgePoint, goCreate }) {
  ...
  const { id, imgUrl, user_name } = homeSelectItem;
  ...
  useEffect(() => {
    axios.get(api.getCommonStoryDetail, { params: { id } }).then((res) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={[styles.tagTxt]}>的故事吧！</Text>
        </View>
                ...
                style={[
                  {
                    ...
                    paddingLeft:isPhone ? pxToDpWidthLs(90):pxToDp(60),
                    paddingRight:isPhone ? pxToDpWidthLs(120):pxToDp(120),
                  },
                ]}
              >
                {title_content}
      ...
      <View style={[styles.right]}>
        <TouchableOpacity
          style={[appStyle.flexTopLine, appStyle.flexAliEnd]}
          onPress={goCreate}
        >
          <Image
            resizeMode="stretch"
          ...
          <View style={[styles.tipsWrap, appStyle.flexCenter]}>
            <Text
              style={[
                {
                  color: "#283139",
                  fontSize: isPhone ? pxToDpWidthLs(30) : pxToDp(37),
                },
            ...
            <View style={[styles.addWrap, appStyle.flexCenter]}>
              <Text
                style={[
                  {
                    color: "#283139",
                    fontSize: isPhone ? pxToDpWidthLs(46) : pxToDp(58),
                  },
...
const stylesHandset = StyleSheet.create({
  ...
  addWrap: {
    width: pxToDpWidthLs(46),
    height: pxToDpWidthLs(46),
    borderRadius: pxToDpWidthLs(16),
    backgroundColor: "#fff",
    position: "absolute",
    right: pxToDpWidthLs(8),
  },
});
