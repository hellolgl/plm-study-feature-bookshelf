...
class speWrongExerciseListSmart extends PureComponent {
    ...
    getList = (page) => {
        ...
        if (data.sub_modular === '3') {

            axios.get(api.chineseGetDailySentenceExerciseRecordLevel, { params: { ...senobj } }).then((res) => {
                let list = res.data.data;
            ...
            axios.get(api.chineseGetDailySentenceExerciseRecord, { params: { ...senobj } }).then((res) => {
                let list = res.data.data;
                console.log("list", list);
                                            ...
                                            <View style={{ flexDirection: 'row', alignItems: 'flex-end', }}>
                                                <View style={{ flex: 1, }}>
                                                    ...
                                                    <View style={[appStyle.flexTopLine]}>
                                                        ...
                                                        {/* {item.sentence_stem
                                                            ? item.sentence_stem.map((child, index) => {
                                                                return (
                                                                    <Text
                                                                        style={[
                                                                            {
