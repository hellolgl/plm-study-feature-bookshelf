...
class SpeSentenceExercise extends PureComponent {
  ...
  componentDidMount() {
    ...
    axios.get(api.chineseGetDailySentenceExercise, { params: obj }).then((res) => {
  ...
  changeScene = (currentTopic) => {
    ...
    // console.log("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%", currentTopic.scene_word)
    return currentTopic
  }
  goBack = () => {
                            ...
                            return (
                              <Text
                                style={[
                                  ...
                                  }, appFont.fontFamily_syst, fontFamilyRestoreMargin('', '', Platform.OS === 'ios' ? null : { marginTop: pxToDp(16) })
                                ]}
                                key={index}
                              >
                                {item.content}
