...
const ChangeType = ({ show, close, typeName, label, check }) => {
    const typelist = [
        {
            txt: "同步错题",
            type: "flow",
            ...
            >
                ...
                <View>
                    <TouchableOpacity onPress={close} style={[styles.changeBtnWrap]}>
                        <Text style={[styles.changeBtnTxt]}>{label}</Text>
                        <Image
                ...
                <View style={[styles.content]}>
                    <View style={[styles.inner]}>
                        <Text style={[styles.titleTxt]}>切换错题集</Text>
                        <View>
                            {typelist.map((item, index) => {
                                return (
                                    <TouchableOpacity
                                        key={index}
                                        onPress={() => check(item.txt, index)}
                                        style={[
                                            styles.itemWrap,
