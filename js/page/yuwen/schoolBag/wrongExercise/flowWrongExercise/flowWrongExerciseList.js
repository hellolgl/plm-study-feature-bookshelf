...
class FlowWrongExerciseList extends PureComponent {
    ...
    getList = (page) => {
        ...
        axios
            .get(
                `${api.getTextbookWrongExerciseList}/${data.origin}/${data.index}?page=${page}&page_size=10`
            )
            .then((res) => {
    ...
    render() {
        const { totalpage, loading, page } = this.state;
        return (
            <ImageBackground
            ...
            >
                <View style={[styles.headerWrap]}>
                    ...
                    <Text style={[styles.headerxt]}>
                        {this.state.data.learning_point}
                    </Text>
