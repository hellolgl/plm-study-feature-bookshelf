...
import SentenceModal from "../../../../children/studyCharacter/components/SentenceModal";
import StarModal from "../../../../children/studyCharacter/components/StarModal";
...
class StudyCharacterPage extends PureComponent {
    ...
    componentWillUnmount() {
        DeviceEventEmitter.emit("refreshPinyinStudy"); //返回页面刷新
    }

    getData = () => {
        const { step_list, step_index, star_num } = this.state;
        const { p_id, knowledge_point } = this.props.navigation.state.params.data;
    ...
    getStruck = () => {
        axios
            .get(api.getPinyinOneWordStruck, {
                params: {
                    // word_level_id: this.word_level_id,
        ...
        return (
            <View style={[appStyle.flexCenter, { height: "100%" }]}>
                <Image
                    ...
                    source={OS === 'android' ? require("../../../../../images/chineseHomepage/pingyin/new/bg_1.png") : require("../../../../../images/chineseHomepage/pingyin/new/bg_1_ios.png")}
                ></Image>
                <ImageBackground
                ...
                >
                    ...
                    <Image
                        ...
                        source={
                            isRecording_1
                                ? ""
                                : require("../../../../../images/chineseHomepage/pingyin/new/box_shadow_1.png")
                        }
                    ></Image>
                    <View
                        style={[
    ...
    render() {
        ...
        return (
            <ImageBackground
                source={require("../../../../../images/chineseHomepage/pingyin/new/wrapBg.png")}
...
export default StudyCharacterPage;
