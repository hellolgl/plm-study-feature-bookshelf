...
import { View, Text, StyleSheet, Image, TouchableOpacity, PanResponder, Platform, ImageBackground } from 'react-native'
...
class SvgDrawTest extends Component {
    ...
    render() {
        ...
        let know = this.props.navigation.state.params.data.knowledge_point
        let pinyin_mat = know.split('')         // 字符串组
        // pinyin_mat = ['b', 'j', 'm']         // 字符串组
        let img_resource_mat = {}
        let width = 0
        pinyin_mat.forEach((item, index) => {
            img_resource_mat[item] = { uri: `${url.baseURL}pinyin/alphabet_image/${item}.png` }
        ...
        return (<View></View>
            ...
            //                 require('../../../../../images/chineseHomepage/pingyin/ios/writeBlack.png') :
            //                 require('../../../../../images/chineseHomepage/pingyin/writeBlack.png')}
            //             style={[appStyle.flexCenter, padding_tool(Platform.OS === 'ios' ? 30 : 20, 100, 60, 100), { width: '100%', height: Platform.OS === 'ios' ? pxToDp(1430) : pxToDp(1070) }]}
            //         >
            //             <Text
            //                 style={[{
            //                     fontSize: pxToDp(50),
            //                     color: "#fff", marginBottom: pxToDp(0)
            //                 }, appFont.fontFamily_syst, fontFamilyRestoreMargin('', -28)]}
            //             >写一写</Text>
            //             <View style={[{ flex: 1, width: '100%', }, appStyle.flexCenter, padding_tool(0, 0, 0, 0)]}>
            //                 <ImageBackground
            //                     source={require('../../../../../images/chineseHomepage/pingyin/writeBg.png')}
            //                     style={[appStyle.flexCenter, size_tool(1520, 650)]}
            //                 >
