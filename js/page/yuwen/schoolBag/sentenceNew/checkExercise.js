...
class DoWrongExercise extends PureComponent {
    ...
    componentDidMount() {
        ...
        this.nextTopaicListener = DeviceEventEmitter.addListener(
            "nextTopaic",
            (event) => {
                this.nextTopaic()
            }
    ...
    componentWillUnmount() {
        this.nextTopaicListener && this.nextTopaicListener.remove()
    }
                ...
                <View style={[styles.container, appStyle.flexTopLine]}>
                    ...
                    <View style={styles.topaic}>
                        <View style={[styles.type]}>
                            {this.skill_grade(exerciseInfo.exercise_level)}
                            <Text style={[styles.type_txt]}>
                                {exerciseInfo.element_type}
                                {/* {exerciseInfo.knowledge_name}—{
                                    exerciseInfo.knowledge_type === 0 ? '概念' : '程序'
                                } */}
                            </Text>
                        </View>
                        <ScrollView style={[{ width: "100%", height: "100%", marginTop: pxToDp(40) }]}>
