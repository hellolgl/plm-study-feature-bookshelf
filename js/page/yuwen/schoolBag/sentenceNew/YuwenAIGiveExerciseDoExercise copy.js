...
import { changeTopicData, initTopicData } from "../../../math/tools";
...
import { diagnosis } from "../../../math/MathDiagnosis";
...
class YuwenAIGiveExerciseDoExercise extends PureComponent {
    constructor(props) {
        super(props);
    ...
    getData = () => {
        ...
        const { checkGrade, checkTeam } = this.props.userInfo.toJS();
        let data = {
            grade_code: checkGrade,
            term_code: checkTeam,
            // status: status
        };
        axios.get(api.intelligenceAiExercises, { params: data })
            .then((res) => {


                let currentTopic = res.data.data;

                currentTopic.public_exercise_stem = currentTopic.private_exercise_stem;
                ...
                currentTopic.choice_content = currentTopic.exercise_content.join('#');
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <TouchableOpacity style={[styles.caogao_btn]}>
                    {/* <Image
                    ...
                    <Text
                        style={[
                            { color: "white", fontSize: pxToDp(32), marginLeft: pxToDp(4) },
                ...
                <View style={[styles.content]}>
                    ...
                    {topicIndex === topic_num_list.length - 1 ? null : topicIndex !== 0 && (
                        <TouchableOpacity
...
export default connect(mapStateToProps, mapDispathToProps)(YuwenAIGiveExerciseDoExercise);
