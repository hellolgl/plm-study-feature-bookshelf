...
function CompositionTalk({
    ...
    const grade_code = currentUserInfo.checkGrade;
    const term_code = currentUserInfo.checkTeam;
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            if (!messages.length) {
                ...
                const data = { inspect: inspect, tag: tag, grade: grade, grade_code: grade_code, term_code: term_code };
                if (chatLoading === false) {
                    const history_res = await axios.post(api.getCompositionAiBotHisotry, data);
                    ...
                    // });
                    try {
                        const res = await axios.post(api.getCompositionAiHelp, data)
...
export default CompositionTalk;
