...
export default {
  ...
  listen(classname) {
    ...
    // 支持 PC 端
    canvasDiv.addEventListener("pointerdown", function (e) {
      //console.log("down")
      toServeX.push("#");
      toServeY.push("#");
      paint = true;
    ...
    canvasDiv.addEventListener("pointerup", function () {
  ...
  /* 改变画笔大小 */
  changePaintWidth(width) {
    //console.log("change Paint Width")
    context.lineWidth = width;
  },
  //渲染服务器返回数据;
  diagnosis(data) {
    fromServeData = { ...data };
    //console.log(fromServeData,"fromServeData")
