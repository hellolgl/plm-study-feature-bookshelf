...
export default class Record extends Component {
    ...
    async componentDidMount() {
        ...
        this.eventListener = EventRegister.addEventListener('stopRecord', (data) => {
            try {
    ...
    start = async () => {
        ...
        AudioRecord.on('data', data => {
            ...
            const lineColor = JSON.stringify(this.props.lineColor)
            if (this.loaded) {
                console.log('webviewnow',)
                // this.webviewRef.injectJavaScript(`
                //   setTimeout(() => {
                //     console.log('webviewnow 里面')
                //      waveform.updateEvent(${renderData},${lineColor});
                //   }, 200)
                // `)
            }
        })
        console.log('audio================', AudioRecord)
    ...
    stop = async () => {
        ...
        try {
            if (this.endTime - this.startTime > 500) {
                console.log('stopstop================', AudioRecord.stop())
...
updateEvent = (data,color) => {
    ...
    ctx.strokeStyle = color?color:'#4C94FF'
