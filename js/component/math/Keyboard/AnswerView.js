...
class AnswerView extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
...
CharView = () => {
    ...
    char_view_mat = <View style={[appStyle.flexLine,Platform.OS === 'android'?{ minHeight:pxToDp(68)}:null]}>
        {row_view_mat}
        <Text></Text>
    </View>
