...
import Canvas from '../../util/canvas/MathBagWebCanvas'
...
export default class ModalDialog extends Component {
    ...
    constructor(props) {
        ...
        this.handleDialogLeftBtnActionThrottled = _.throttle(this._dialogLeftBtnAction, 3 * 1000);
        this.handleDialogThreeBtnActionThrottled = _.throttle(this._dialogThreeBtnAction, 3 * 1000);
        this.state = {
    ...
    handleBase64 = (data) => {
        ...
        // this.props._dialogLeftBtnAction(data);
    }
    ...
    _dialogThreeBtnAction = () => {
        this.props._dialogThreeBtnAction();
        this.usbUtil.clearListXY();
    }
                ...
                <View style={styles.bg}>
                    <View style={styles.dialog}>
                        ...
                        <View style={styles.dialogBtnView}>
                            <BaseButton style={{height:40,borderRadius: 80,}} onPress={this.handleDialogLeftBtnActionThrottled} text={'识别'}></BaseButton>
                            <BaseButton style={{height:40,borderRadius: 80,}}onPress={this._dialogRightBtnAction} text={'清空'}></BaseButton>
                            <BaseButton style={{height:40,borderRadius: 80,}}onPress={this.handleDialogThreeBtnActionThrottled} text={'提交'}></BaseButton>
