...
export default class EnglishCanvasDialog extends Component {
    ...
    eventHandler = (message) => {
        ...
        if (!this.canvas || !this.canvas.webview || !this.state.isUseBle) return
                ...
                <View style={styles.bg}>
                    <View style={styles.dialog}>
                        ...
                        <View style={styles.dialogBtnView}>
                            <BaseButton style={{height:40,borderRadius: 80,}} onPress={this._dialogLeftBtnAction} text={'下一题'}></BaseButton>
                            <BaseButton style={{height:40,borderRadius: 80,}} onPress={this._dialogRightBtnAction} text={'清空'}></BaseButton>
                            {/* <BaseButton onPress={this._useBleData} text={isUseBle?'平板作答':'数位板作答'}></BaseButton> */}
                        </View>
