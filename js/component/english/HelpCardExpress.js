                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Text style={[{ color: "#FFFFFF" }, appFont.f42, appFont.bold]}>
                                        {this.props.word}
                                    </Text>
                                    <View
                                        style={[
                                ...
                                <View style={[appStyle.flexAliCenter,{padding: pxToDp(24)}]}>

                                    <Image
                                        style={[{ width: this.props.imgWidth || pxToDp(364), height: this.props.imgHeight || pxToDp(270), resizeMode: 'contain', borderRadius: pxToDp(18) }]}
